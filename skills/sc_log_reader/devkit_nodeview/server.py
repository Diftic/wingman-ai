"""
SC_LogReader DevKit NodeView - Web Server

FastAPI server with SSE endpoint for real-time node diagram dashboard.
...
def create_app(bridge: DebugBridge) -> FastAPI:
    ...
    app = FastAPI(title="SC_LogReader DevKit NodeView")
