...
try:
    ...
    try:
        ...
        # NavPoint: Wingman's frozen NumPy 2 includes the real _core module,
        # but omits this legacy forwarding module. Keep the existing native
        # NumPy/OpenCV implementation; do not manufacture global aliases.
        if exc.name not in ('numpy.core', 'numpy.core.multiarray'):
            raise
