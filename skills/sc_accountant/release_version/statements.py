...
def generate_balance_sheet(
    ...
    Assets = Cash + Ships + Components + Vehicles + Cargo
    Equity = Total Assets
    ...
    Returns:
        Dict with assets and equity sections.
    """
    ...
    total_assets = cash + ships_value + components_value + vehicles_value + cargo_value
